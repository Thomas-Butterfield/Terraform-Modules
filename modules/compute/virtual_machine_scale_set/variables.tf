...
variable "settings" {
  description = "Configuration settings object for the Virtual Machine Scale set resource"
}
variable "application_security_groups" {
  description = "Application Security Groups module object"
}
variable "application_gateways" {
  description = "Application Gateways module object"
}
variable "keyvaults" {
...
variable "load_balancers" {
  description = "Load Balancers module object"
}
