locals {
  ...
  windows_osdisk_name_mask = "{vmnameprefix}{delimiter}{postfix}{delimiter}{osdisk}{delimiter}{vmss}"
}
...
module "resource_naming_osdisk_windows" {
  source   = "../../resource_naming"
  for_each = local.os_type == "windows" ? var.settings.vmss_settings : {}
...
resource "azurerm_windows_virtual_machine_scale_set" "vmss" {
  ...
  os_disk {
    name                      = module.resource_naming_osdisk_windows[each.key].name_result
