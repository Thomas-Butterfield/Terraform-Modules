locals {
  ...
  legacy_vm_name_mask = "{vmnameprefix}{delimiter}{postfix}"
  # Name of the Windows computer name
  legacy_computer_name_mask = "{vmnameprefix}{delimiter}{postfix}"
  # Name for the OS disk
  legacy_osdisk_name_mask = "{vmnameprefix}{delimiter}{postfix}{delimiter}{osdisk}"
  # Name for the Data disk
  legacy_datadisk_name_mask = "{vmnameprefix}{delimiter}{postfix}{delimiter}{datadisk}"
}
...
resource "azurerm_virtual_machine" "vm" {
  ...
  dynamic "storage_data_disk" {
    ...
    content {
      name                      = module.resource_naming_legacy_datadisk_name[each.key].name_result
