...
output "possible_outbound_ip_addresses" {
  ...
  value       = azurerm_linux_web_app_slot.webapp.possible_outbound_ip_addresses
}

output "site_credential" {
  description = "A site_credential block containing name and password"
  value       = azurerm_linux_web_app_slot.webapp.site_credential
}
