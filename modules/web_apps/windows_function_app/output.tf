...
output "custom_domain_verification_id" {
  ...
  value       = azurerm_windows_function_app.functionapp.custom_domain_verification_id
}
...
output "identity" {
  ...
  value       = azurerm_windows_function_app.functionapp.identity
}

output "kind" {
  description = "The Kind value for this Windows Function App"
  value       = azurerm_windows_function_app.functionapp.kind
}

output "outbound_ip_address_list" {
  description = "A list of outbound IP addresses - such as [\"52.23.25.3\", \"52.143.43.12\"]"
  value       = azurerm_windows_function_app.functionapp.outbound_ip_address_list
}

output "outbound_ip_addresses" {
  description = "A comma separated list of outbound IP addresses - such as 52.23.25.3,52.143.43.12"
  value       = azurerm_windows_function_app.functionapp.outbound_ip_addresses
}

output "possible_outbound_ip_address_list" {
  description = "A possible_outbound_ip_address_list block as defined below"
  value       = azurerm_windows_function_app.functionapp.possible_outbound_ip_address_list
}
...
output "possible_outbound_ip_addresses" {
  ...
  value       = azurerm_windows_function_app.functionapp.possible_outbound_ip_addresses
}

output "site_credential" {
  description = "A site_credential block containing name and password"
  value       = azurerm_windows_function_app.functionapp.site_credential
}
