...
| Name | Type |
|------|------|
| [azurerm_linux_function_app.functionapp](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/linux_function_app) | resource |
...
| <a name="input_service_plan_id"></a> [service\_plan\_id](#input\_service\_plan\_id) | The ID of the Service Plan that this Linux Function App will be created in | `any` | n/a | yes |
