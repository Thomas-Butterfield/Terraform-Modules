  ...
  site_config {
    ...
    dynamic "application_stack" {
      ...
      content {
        ...
        dynamic "docker" {
          for_each = try(var.settings.site_config.application_stack.dockers, {})

          content {
            registry_url      = try(docker.value.registry_url, null)
            image_name        = try(docker.value.image_name, null)
            image_tag         = try(docker.value.image_tag, null)
