...
output "custom_domain_verification_id" {
  ...
  value       = azurerm_windows_web_app.webapp.custom_domain_verification_id
}
...
output "kind" {
  ...
  value       = azurerm_windows_web_app.webapp.kind
}

output "outbound_ip_address_list" {
  description = "A list of outbound IP addresses - such as [\"52.23.25.3\", \"52.143.43.12\"]"
  value       = azurerm_windows_web_app.webapp.outbound_ip_address_list
}
...
output "possible_outbound_ip_address_list" {
  ...
  value       = azurerm_windows_web_app.webapp.possible_outbound_ip_address_list
}
...
output "possible_outbound_ip_addresses" {
  ...
  value       = azurerm_windows_web_app.webapp.possible_outbound_ip_addresses
}

output "site_credential" {
  description = "A site_credential block containing name and password"
  value       = azurerm_windows_web_app.webapp.site_credential
}
