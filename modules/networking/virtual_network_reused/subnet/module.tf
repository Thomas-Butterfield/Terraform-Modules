...
resource "azurerm_subnet" "subnet" {
  ...
  name                 = (var.name == "AzureBastionSubnet") || (var.name == "AzureFirewallSubnet") || (var.name == "GatewaySubnet") || (var.name == "RouteServerSubnet") ? var.name : module.resource_naming.name_result
