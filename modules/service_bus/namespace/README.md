...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_namespace_auth_rules"></a> [namespace\_auth\_rules](#module\_namespace\_auth\_rules) | ./namespace_auth_rule | n/a |
| <a name="module_network_rule_sets"></a> [network\_rule\_sets](#module\_network\_rule\_sets) | ./network_rule_set | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | The ID of the ServiceBus Namespace |
| <a name="output_name"></a> [name](#output\_name) | The name of the ServiceBus Namespace |
<!-- END_TF_DOCS -->