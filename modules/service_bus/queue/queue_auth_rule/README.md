...
| <a name="input_servicebus_queue_id"></a> [servicebus\_queue\_id](#input\_servicebus\_queue\_id) | ServiceBus Queue ID | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | The ID of the ServiceBus Authorization rule |
| <a name="output_name"></a> [name](#output\_name) | The Name of the ServiceBus Authorization rule |
<!-- END_TF_DOCS -->